<template>
    ...
    <div class="md:h-75 md:flex mb-2 w-full">
            <input id="search" @keyup.enter="search_projects" v-model="search" class="border-2 mx-auto border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
